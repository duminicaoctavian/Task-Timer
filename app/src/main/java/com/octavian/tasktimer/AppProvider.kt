...
class AppProvider: ContentProvider() {
    ...
    override fun query(uri: Uri, projection: Array<out String>?, selection: String?,
        ...
        when (match) {
            ...
            TASKS_ID -> {
                ...
                queryBuilder.appendWhereEscapeString("$taskId") // avoid SQL Injection attacks
            }
        ...
        val context = context ?: throw NullPointerException("query: Context cannot be null!")
    ...
    override fun insert(uri: Uri, values: ContentValues?): Uri {
        ...
        val context = context ?: throw java.lang.NullPointerException("insert: Context cannot be null!")
    ...
    override fun update(uri: Uri, values: ContentValues?, selection: String?, selectionArgs: Array<out String>?): Int {
        ...
        val context = context ?: throw java.lang.NullPointerException("update: Context cannot be null!")
    ...
    override fun delete(uri: Uri, selection: String?, selectionArgs: Array<out String>?): Int {
        ...
        val context = context ?: throw java.lang.NullPointerException("delete: Context cannot be null!")
